...
**VortexGram4A** is a fork of [exteraGram](https://github.com/exteraSquad/exteraGram) with
...
**VortexGram4A** does **NOT** include proprietary **exteraGram** features.
...
But since **VortexGram** is based on **exteraGram**, also join their project
